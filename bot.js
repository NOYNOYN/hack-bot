...
var prefix = "-"
       ...
       client.on("message", (message) => {
        ...
        if (!message.guild.roles.exists("name", "◆ Host Support")) return message.channel.send(`This server doesn't have a \`Support Team\` role made, so the ticket won't be opened.\nIf you are an administrator, make one with that name exactly and give it to users that should be able to see tickets.`);
